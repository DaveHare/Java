 ...
 */
public class MinArrayList <T> implements List<T>, RandomAccess {
	...
	public boolean addAll(int index, Collection<? extends T> c) {
		...
		// Flytter elementer for å skape stor nok glipe i lista
		for (int i=antallElementer - 1;i>=index;i--) {
	...
	private class MinListIterator implements ListIterator<T> {
		...
		public void add(T arg0) {
			MinArrayList.this.add(posisjon, arg0);
		}
		...
		@Override
		public void remove() {
			MinArrayList.this.remove(posisjon);
		}

		@Override
		public void set(T e) {
			MinArrayList.this.set(posisjon, e);
		}
