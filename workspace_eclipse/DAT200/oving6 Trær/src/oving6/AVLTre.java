...
public class AVLTre <K extends Comparable<? super K>, V> implements SortedMap<K, V> {
	...
	private void skrivUtTre(Binaertrenode noden) {
		...
		System.out.println("Nokkel: " + noden.nokkel + " verdi: " + noden.verdi + " ");
		if (noden.venstrebarn != null) {
			System.out.println("	Venstre: " + noden.venstrebarn.nokkel + " ");
		}
		if (noden.hoyrebarn != null) {
			System.out.println("	Høyre: " + noden.hoyrebarn.nokkel + " ");			
		}
		System.out.println();
